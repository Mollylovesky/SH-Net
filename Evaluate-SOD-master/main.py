...
import os
from evaluator2 import Eval_thread
...
if __name__ == "__main__":
    ...
    parser.add_argument('--methods', type=str, default='CMC')
    parser.add_argument('--datasets', type=str, default='ORSSD')
    parser.add_argument('--root_dir', type=str, default=r'E:/Evaluate-SOD-master')
    parser.add_argument('--save_dir', type=str, default=r'E:/Evaluate-SOD-master')
