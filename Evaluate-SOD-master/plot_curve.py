...
#styles = ['.--b', '.--g', '.--c', '.-m', '.-y', '.-k', '.-c', '.-r']
lines = [ '--', '--', '--', '--', '--', '-', '-', '-', '-', '-']
points = ['.', '.', '.', '.', '.', '.', '.', '.', '.', '*']
colors = ['gold', 'orange', 'g', 'c', 'm', 'violet',  'navy', 'k', 'b', 'r', ]
...
if __name__ == "__main__":
    ...
    parser.add_argument('--methods', type=str, default='DSG''+''SMD''+''SSOD''+''SMFF''+''CMC''+''LVNet''+''DAFNet''+''PoolNet''+''DSS''+''Ours' )
    parser.add_argument('--datasets', type=str, default='ORSSD')
    parser.add_argument('--res_dir', type=str, default='./Detail')
    parser.add_argument('--out_dir', type=str, default='./Detail')
