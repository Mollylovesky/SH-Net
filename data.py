...
def get_loader2(image_root, gt_root, mask_root, gray_root, edge_root, batchsize, trainsize, shuffle=True, num_workers=12, pin_memory=True):

    dataset = SalObjDataset2(image_root, gt_root, mask_root, gray_root, edge_root, trainsize)
