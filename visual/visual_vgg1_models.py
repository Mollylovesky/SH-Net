...
#################################################
        ...
        x_visualize = edge_out # 获取上图红色虚线框住的特征图 X，shape为[1,256,33,33]
        x_visualize = F.interpolate(x_visualize, size=input_size, mode='bilinear', align_corners=False)
        return sal_init, edge_map, [sal_ref,x_visualize]
